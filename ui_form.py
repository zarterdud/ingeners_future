...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(560, 21, 271, 171))
        ...
        self.len_template_X = QtWidgets.QLineEdit(self.layoutWidget)
        self.len_template_X.setText("")
        self.len_template_X.setObjectName("len_template_X")
        self.verticalLayout_5.addWidget(self.len_template_X)
        self.len_template_Y = QtWidgets.QLineEdit(self.layoutWidget)
        self.len_template_Y.setText("")
        self.len_template_Y.setObjectName("len_template_Y")
        self.verticalLayout_5.addWidget(self.len_template_Y)
        self.verticalLayout_7.addLayout(self.verticalLayout_5)
        self.add_template = QtWidgets.QPushButton(self.layoutWidget)
